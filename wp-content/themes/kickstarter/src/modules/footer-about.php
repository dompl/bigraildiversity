<div class="flex-between">
  <div class="about-nimble about">
    <div class="logo">
      <a target="_blank" href="http://www.nimblemedia.co.uk" title="<?php _e('Visit Nimble Media website', 'TEXT_DOMAIN');?>">
  ...
  <div class="about-wir about">
    <div class="logo">
      <a target="_blank" href="http://www.womeninrail.org" title="<?php _e('Visit Women in Rail websit', 'TEXT_DOMAIN');?>">
