    ...
    class VC_BRDC_Single_Image extends Visual_Composer_General_Settings
    {
            ...
            $params = array(
                ...
                array(
                    ...
                    'value'       => array(
                        ...
                        __( 'Open YouTube PopUp', 'TEXT_DOMAIN' ) => 'youtube'
                    ),
                ...
                array(
                    ...
                    'holder'      => 'div',
                    'class'       => 'vc_label bold',
                    'heading'     => __( 'YouTube Video ID', 'TEXT_DOMAIN' ),
                    'param_name'  => 'youtube_id',
                    'group'       => __( 'Content', 'TEXT_DOMAIN' ),
                    'value'       => __( '', 'TEXT_DOMAIN' ),
                    'description' => __( 'Add YouTube Video ID', 'TEXT_DOMAIN' ),
                    'dependency'  => array(
                        'element' => 'custom_link',
                        'value'   => 'youtube'
                    )
        ...
        public function VC_BRDC_Single_Image_shortcode_callback( $atts )
        {
            ...
            if ( $custom_link != 'none' ) {
                ...
                if ( $custom_link == 'youtube' ) {
                    $random = rand( 999, 99999999 );

                    $a_open  = '<a href="#yt-pop-' . $random . '" class="yt-pop">';
                    $a_close = '</a>';

                    $a_close .= '<div id="yt-pop-' . $random . '" style="display:none;">';
                    $a_close .= do_shortcode( '[youtube id="' . $youtube_id . '"]' );
                    $a_close .= '</div>';

                } elseif ( $custom_link == 'lightbox' ) {
