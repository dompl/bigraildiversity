...
$output .= $brdc_container_width === 'container-wide' || $brdc_container_width === 'container-narrow' ? '<div class="container-inner clx ' . ($brdc_container_prevent_margins_hor == true ? 'prevent-margin-hor ' : '') . ($brdc_container_prevent_margins == true ? 'prevent-margin' : '') .' container-inner-' . $brdc_container_width . '">' : '';
