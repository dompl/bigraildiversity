...
* https://gist.github.com/dompl/81ad962e5d23922f7587053d3af1e00b
 ...
 * se
 * namespace config\transients;
 * _transients::delete( "messages" ); // takes 1 param, the cache key
...
class transient {
    ...
    public $per_item, $is_object, $batches, $timeout, $key;
    ...
    public static function set($data, $timeout, $key, $per_item = null) {
        $class = null == self::$instance ? new self : self::$instance();
        return $class->_set($data, $timeout, $key, $per_item);
    }

    public static function get($key, $callback = null, $timeout = null, $per_item = null) {
        $class = null == self::$instance ? new self : self::$instance();
    ...
    public function _set($data, $timeout, $key, $per_item = null) {
    ...
    public function _get($key, $callback = null, $timeout = null, $per_item = null) {
    ...
    public function _delete($key) {
        ...
        if ( ! $this->batches) {
            delete_transient("se_transients__{$this->key}");
        } else {

            for ($i = 0; $i < $this->batches; $i++) {
                delete_transient("se_transients__{$key}_{$i}");
            }
