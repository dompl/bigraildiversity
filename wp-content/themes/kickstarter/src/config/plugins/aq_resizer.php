...
if(!class_exists('Aq_Resize')) {
    ...
    class Aq_Resize
    {
        ...
        public function process( $attachment, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
            // Get image url by ID or string.
            $url = ( is_int( $attachment ) ) ? wp_get_attachment_url( $attachment ) : $attachment;
...
if(!function_exists('aq_resize')) {
    ...
    function aq_resize( $attachment, $width = null, $height = null, $crop = null, $single = true, $upscale = false ) {
        ...
        if ( defined( 'ICL_SITEPRESS_VERSION' ) ){
            global $sitepress;
            $attachment = $sitepress->convert_url( $attachment, $sitepress->get_default_language() );
        }
        /* WPML Fix */

        $aq_resize = Aq_Resize::getInstance();
        return $aq_resize->process( $attachment, $width, $height, $crop, $single, $upscale );
    }
}
