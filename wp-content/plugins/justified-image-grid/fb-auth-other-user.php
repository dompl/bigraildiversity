...
<?php
  if(!empty($_GET["code"])){
    $code = $_GET["code"];
    ?>
    <h1>Authorization complete, please send this code to the person who sent you the link.</h1><p>By doing so, they'll have view access to your photos, videos and the content of the pages you are an admin of, and can load them in a gallery outside Facebook.</p>
